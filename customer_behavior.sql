...
--4.compare the average purchase amounts between and express shipping.
...
--6.which top 5 products have the highest percentage of purchases with discounts applied?
...
--8.whart are the top 3 most purchased products within each category?
with item_counts as(
